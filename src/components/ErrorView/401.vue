    ...
    <div class="contact">
      ...
      >
        <el-form-item label="申请用户类型" prop="licenseUserType">
          <el-select v-model="licenseInfo.licenseUserType" placeholder="请选择用户类型">
        ...
        <el-form-item label="申请用户名称" prop="licenseUser">
          <el-input v-model="licenseInfo.licenseUser" />
        </el-form-item>
        <el-form-item label="设备序号" prop="deviceNo">
          <el-input v-model="licenseInfo.deviceNo" />
        </el-form-item>
        <el-form-item label="邮箱(接受授权码)" prop="email">
          <el-input v-model="licenseInfo.email" />
        </el-form-item>
        <el-form-item>
          <el-button type="primary" @click="offline">线下申请</el-button>
          <el-button :disabled="!ifHasNet" type="primary" @click="online">线上申请</el-button>
        </el-form-item>
...
import { setLicense, getLicenseCode, getOffLineCode, getConnectFlag } from '@/api/auth'
...
const exportAuthCode = txt => {
  const filename = `标识解析 & 边缘计算-申请码(${licenseInfo.value.licenseUser}-${licenseInfo.value.deviceNo})`
